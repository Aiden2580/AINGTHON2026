...
**정부에 한걸음 더 다가갈 수 있는 정책 플랫폼**

하루에도 수십개씩 쏟아지는 정부 정책과 파편화된 지방정부 정책을 정리해주고, 관심있는 주제는 사람들과 바로 토론해볼 수 있는 참여정치 플랫폼입니다.
OpenAPI Key를 발급받아 정부 발표,법제처,각 부처 정책을 자동으로 수집하고, 태그별로 분류하고, AI가 요약해줍니다.

관심있는 정책, 법률 개정안이 있다면 전문을 읽지 않아도 됩니다. Agora를 이용하면 정보의 홍수 속에서 원하는 정보만, 요약시켜 받아볼 수 있습니다. 더 관심이 생긴다면 그 때 전문을 읽을 수 있도록 핫 링크도 제공합니다.

무엇을 볼지 모르겠나요? 개설된 토론을 확인해보세요. 사람들이 많이 관심을 가지는 주제, 최신 정책과 법률개정안으로 토롱늘 개설할 수 있고 개설된 토론에 자유롭게 참여할 수 있습니다.

직장인 플랫폼 Blind의 소속 기반 익명에 착안하여 대학교 인증, 기관 인증등을 통해 반 실명제 토론을 진행할 수 있습니다. AI를 통해 여론 조작 시도, 악성 글 게시 시도를 자동으로 차단합니다.
...
| 📰 **정보** | 8개 카테고리 정책 피드, 태그별 분류, AI 요약 기능 제공 |
